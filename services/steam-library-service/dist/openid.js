...
exports.buildSteamLoginUrl = buildSteamLoginUrl;
exports.validateSteamCallback = validateSteamCallback;
...
function buildSteamLoginUrl(state) {
...
async function validateSteamCallback(searchParams) {
    ...
    try {
        const response = await (0, node_fetch_1.default)(STEAM_OPENID_ENDPOINT, {
            method: 'POST',
            headers: {
