...
export class ByteBuffer {
    ...
    constructor(value: number | Uint8Array, littleEndian: boolean = false) {
    ...
    private bytesUsed(amount: number, reading: boolean): void {
