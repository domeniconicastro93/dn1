...
async function main() {
    ...
    // Use findFirst instead of findUnique just in case email isn't marked unique in Prisma schema (though it should be)
    // Or maybe the error was due to something else.
