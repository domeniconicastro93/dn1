...
export class StreamInput {
    ...
    setPeer(peer) {
        ...
        if (this.peer) {
            ...
            (_b = this.mouseClicks) === null || _b === void 0 ? void 0 : _b.close();
            (_c = this.mouseAbsolute) === null || _c === void 0 ? void 0 : _c.close();
            (_d = this.mouseRelative) === null || _d === void 0 ? void 0 : _d.close();
            (_e = this.touch) === null || _e === void 0 ? void 0 : _e.close();
            (_f = this.controllers) === null || _f === void 0 ? void 0 : _f.close();
